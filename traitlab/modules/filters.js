...
class TokenFilters {
    ...
    filterFloppyTokens(tokens) {
        ...
        const floppyTokens = tokens.filter(token => {
            ...
            // Solo usar rangos específicos de index.html: 10000-10015, 15000-15015, y pack 1123
            const isFloppyById = (tokenId >= 10000 && tokenId <= 10015) || 
    ...
    isFloppyToken(token) {
        ...
        // Solo usar rangos específicos de index.html: 10000-10015, 15000-15015, y pack 1123
        return (tokenId >= 10000 && tokenId <= 10015) || 
               (tokenId >= 15000 && tokenId <= 15015) ||
               tokenId === 1123;
    }

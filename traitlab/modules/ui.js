...
class UIManager {
    ...
    createTokenCard(token) {
            ...
            // Verificar de manera más robusta si virtual DOM está activo
            const virtualDOMState = this.virtualDOMState;
            const isVirtualDOMActive = !!(virtualDOMState && virtualDOMState.enabled === true);
            ...
            imgTag = `<img src="${imageUrl}" alt="${displayTitle}" class="token-image" loading="lazy" data-loading="true" onload="this.removeAttribute('data-loading')" onerror="if('${fallbackUrl}') { this.src='${fallbackUrl}'; this.onerror=function(){ this.src='data:image/svg+xml;base64,'; this.removeAttribute('data-loading'); }; }">`;
            } else {

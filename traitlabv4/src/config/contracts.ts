...
export const CONTRACT_ADDRESSES = {
  ...
  // F5 (packs data layer): floppies pagados en ETH / con allowlist Merkle —
  // no estaban en este config, solo en Contratos/CONTRACTS_REGISTRY.md.
  ADRIAN_FLOPPY_ETH: '0x9165753093BA640b34d8111Cb9C9D1325799D251',
  ADRIAN_FLOPPY_MERKLE: '0xBf67530f57A22037C9FA372037dEc531DDBa3C29',

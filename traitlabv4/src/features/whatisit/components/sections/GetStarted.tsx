    ...
    <Section id="section-start" title="Get Started" emoji="🚀">
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-lg border border-line bg-panel p-6">
          ...
          <h3 className="mb-3 text-center font-bold text-acc">Get $ADRIAN</h3>
          ...
          <a
            ...
            className="block rounded-lg bg-acc px-4 py-2 text-center text-sm font-bold text-acc-fg hover:opacity-90"
          >
            Buy $ADRIAN →
          </a>
        </div>
        ...
        <div className="rounded-lg border border-line bg-panel p-6">
          ...
          <h3 className="mb-3 text-center font-bold text-acc">Mint ZERO</h3>
          <p className="mb-4 text-center text-sm text-mute">
        ...
        <div className="rounded-lg border border-line bg-panel p-6">
          ...
          <h3 className="mb-3 text-center font-bold text-acc">Use TraitLAB</h3>
          <p className="mb-4 text-center text-sm text-mute">
        ...
        <div className="rounded-lg border border-line bg-panel p-6">
          ...
          <h3 className="mb-3 text-center font-bold text-acc">Join Community</h3>
          <p className="mb-4 text-center text-sm text-mute">
            Discord & Twitter/X
          </p>
          <a

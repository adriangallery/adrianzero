...
export const MOVIES_S2_MOCK: Movie2[] = [
  ...
  { id: 30, name: 'Donatello',             angle: 'pixel',  isMystery: false, revealed: true },
  ...
  { id: 33, name: 'Harley Quinn',          angle: 'horror', isMystery: false, revealed: true },
  { id: 34, name: 'Holly Golightly',       angle: 'cult',   isMystery: false, revealed: true },
  ...
  { id: 41, name: 'Luke, C-3PO & R2-D2',   angle: 'pixel',  isMystery: false, revealed: true },
